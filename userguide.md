...
* ### 1 - Install Software Requirements
    ...
    ![MaximSDK Installer](img\MaximSDK_Installer.JPG)
...
* ### 2 - Enable Workspace Trust
    ...
    ![Workspace Trust Settings](img\workspaceTrust.JPG)
...
* ### 3 - Download the Latest Release of VSCode-Maxim
    ...
    ![Folders](img\Release_folders.JPG)
...
* ### 6 - Edit settings.json
    ...
    ![Opening settings.json](img\settings.JPG)
...
* ### 8 - Build the Program
    ...
    ![Build complete](img\build_complete.JPG)
...
* ### 9 - Debug the Program
    ...
    ![Breakpoint in Hello World](img\breakpoint_helloworld.JPG)
    ...
    ![Debugger Window](img\debugger_window.JPG)
    ...
    ![Breakpoint Hit](img\breakpoint_hit.JPG)
...
* ### 11 - Continue the Program
    ...
    ![Continue button](img\continue_button.JPG)
    ...
    ![Hello World Terminal](img\helloworld_terminal.JPG)
