...
Currently, **only Windows is supported**.  Support for MacOS and possibly Linux toolchains is planned.  MacOS has been tested and found to have some bugs that need fixing with the debugger support.
